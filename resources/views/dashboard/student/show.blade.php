...
@section('content')
    <div class="container">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <ul class="list-group list-group-horizontal border-0 w-100 rounded-0">
                <li class="list-group-item border-0 border-bottom bg-primary col-3 rounded-0 text-white">رقم ولي الامر الاول</li>
                <li class="list-group-item border-0 border-bottom col-9">{{ $student->guardian_f_phone }}</li>
            </ul>
    
            <ul class="list-group list-group-horizontal border-0 w-100 rounded-0">
                <li class="list-group-item border-0 border-bottom bg-primary col-3 rounded-0 text-white">رقم ولي الامر الثاني</li>
            ...
            <ul class="list-group list-group-horizontal border-0 w-100 rounded-0">
                <li class="list-group-item border-0 border-bottom bg-primary col-3 rounded-0 text-white">رقم الوالدة الاول</li>
                <li class="list-group-item border-0 border-bottom col-9">{{ $student->mother_f_phone }}</li>
            </ul>
    
            <ul class="list-group list-group-horizontal border-0 w-100 rounded-0">
                <li class="list-group-item border-0 border-bottom bg-primary col-3 rounded-0 text-white">رقم الوالدة الثاني</li>
